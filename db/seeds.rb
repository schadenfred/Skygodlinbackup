...
user3 = User.create! :name => 'Foo Second User', :account_name => "foo", :email => 'user3@test.com', :password => 'please', :password_confirmation => 'please'
puts 'New user created: ' << user3.name
user4 = User.create! :name => 'Bar Second User', :account_name => "bar", :email => 'user4@test.com', :password => 'please', :password_confirmation => 'please'
